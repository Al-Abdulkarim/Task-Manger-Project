...
$task_id = $_GET["id"];
$task = getTask($task_id, $_SESSION["id"]);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($title)) {
        ...
        if (updateTask($task_id, $_SESSION["id"], $title, $description, $status, $due_date)) {
...
<body>
    ...
    <div class="container">
        <div class="form-container">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?id=" . $task_id); ?>" method="post" onsubmit="return validateTaskForm()">
                <div class="form-group">
                    <label>Title</label>
                    <input type="text" name="title" id="title" class="form-control" value="<?php echo htmlspecialchars($task["title"]); ?>">
                </div>
